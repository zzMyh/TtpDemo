...
import cn.myh.zz.myokhttputils_greendao.utils.Pager;
import cn.myh.zz.myokhttputils_greendao.view.RecyclerViewNoBugLinearLayoutManager;
import okhttp3.Call;

public class CopRentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Pager pager = Pager.newBuilder().setUrl("http://aixiangjia.com.cn:9010/house_rent_app/houseWanted/list")
                        .setLoadMore(true)
                        .setPageSize(20)
                        .setRefreshLayout(materialRefresh)
//                        .putParam("","")
                        .setOnPageListener(new Pager.OnPageListener<HouseWantedsBean>() {

                            @Override
                            public void load(List<HouseWantedsBean> datas, int totalPage, int totalCount) {
                                adapter.loadMoreData(datas);
                                rentRecycler.scrollToPosition(0);
                            }

                            @Override
                            public void refresh(List<HouseWantedsBean> datas, int totalPage, int totalCount) {
                                adapter.loadMoreData(datas);
                                rentRecycler.scrollToPosition(0);
                            }

                            @Override
                            public void loadMore(List<HouseWantedsBean> datas, int totalPage, int totalCount) {
                                adapter.loadMoreData(datas);
                                rentRecycler.scrollToPosition(adapter.getDatas().size());
                            }
                        })
//                        .build(CopRentActivity.this, new TypeToken<BaseInfo<HouseWantedsBean>>() {
                        .build(CopRentActivity.this, new TypeToken<BaseInfo<HouseWantedsBean>>() {
                        }.getType());
                pager.request();
...
//        initData();
    ...
    /*private void initData() {
        ...
        httpHelper.get(url, new SpotsCallBack<BaseInfo<HouseWantedsBean>>(CopRentActivity.this) {
            @Override
...
//                        rentRecycler.setAdapter(rentAdapter);
            ...
            public void onError(Response response, int code, Exception e) {
                Toast.makeText(CopRentActivity.this,"请求失败"+e.getMessage(),Toast.LENGTH_SHORT).show();
...
//    }
    ...
    private void initView() {
        ...
        adapter = new MyRentAdapter(this,R.layout.rent_list_item);
       ...
       /* materialRefresh.setMaterialRefreshListener(new MaterialRefreshListener() {
            ...
            public void onRefreshLoadMore(MaterialRefreshLayout materialRefreshLayout) {
                ...
                if (curPage<=totalPage){
                    ...
                    Toast.makeText(CopRentActivity.this,"已经没有更多数据了",Toast.LENGTH_SHORT).show();
